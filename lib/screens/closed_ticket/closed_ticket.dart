...
class _ClosedTicketState extends State<ClosedTicket> {
  ...
  void initState() {
    ...
    super.initState();
    _myTicketServices.getClosed();
  }

  @override
  Widget build(BuildContext context) {
    return StreamBuilder<List>(
      stream: myTicketStream.close,
          ...
          body: Container(
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  Icon(Icons.local_activity,size: 80,color: Colors.blueGrey.withOpacity(0.7)),
                  SizedBox(
                    height: 10,
                  ),
                  Text("NO CLOSED TICKET FOUND",style: TextStyle(fontFamily: "AppMediumStyle",fontSize: 16,color: Colors.grey[700]),),
                  SizedBox(
                    height: 5,
                  ),
                  Text("You will see here all you're closed tickets.",style: TextStyle(fontFamily: "AppFontStyle",color: Colors.grey),textAlign: TextAlign.center,),
                ],
              ),
            ) :  ListView(
